...
# Основная клавиатура с кнопкой "ПОЛУЧИТЬ РАСЧЕТ" (для поста в канале)
...
Я помогу вам получить расчёт по матрице судьбы.
...
async def handle_text(message: Message):
    ...
    if user_id in awaiting_birth_date:
        ...
        # Если не в процессе ввода даты - показываем стартовое сообщение
...
async def admin_panel(message: Message):
    ...
    stats_text = f"""
📊 Статистика бота:
• Подписчиков получивших расчет: {len(subscribed_users)}
